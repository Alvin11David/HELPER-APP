...
exports.resetPasswordAfterOTP = exports.sendForgotPasswordOTPEmail = exports.sendOTPEmail = void 0;
...
exports.sendOTPEmail = (0, https_1.onCall)(async (request) => {
    try {
...
exports.sendForgotPasswordOTPEmail = (0, https_1.onCall)(async (request) => {
    try {
        const { email, otpCode } = request.data;
        if (!email || !otpCode) {
            throw new Error("Email and OTP code are required");
      ...
      `,
        ...
        const errorMessage = error instanceof Error ? error.message : "Unknown error";
        throw new Error(`Failed to send Forgot Password OTP email: ${errorMessage}`);
    }
});
// Function to reset password after OTP verification
exports.resetPasswordAfterOTP = (0, https_1.onCall)(async (request) => {
    try {
