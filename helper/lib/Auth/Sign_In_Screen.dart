...
class _SignInScreenState extends State<SignInScreen> {
    ...
    if (_mode == _AuthMode.phone) {
      try {
        ...
        if (userQuery.docs.isEmpty) {
          _toast('Phone number not found. Please sign up first.');
          setState(() => _loading = false);
          return;
        }
      ...
      try {
        ...
        if (userQuery.docs.isEmpty) {
          _toast('Invalid email or password. Please check your credentials.');
          setState(() => _loading = false);
          return;
        }
  ...
  // Option 2: Save to Firestore "Sign Up" collection
  // Then navigate to WorkersDashboardScreen()
  // ============================
          ...
          return Stack(
            children: [
              AnimatedAlign(
                ...
                alignment:
                    mode == _AuthMode.phone ? Alignment.centerLeft : Alignment.centerRight,
                child: Container(
                  width: segmentW,
                  height: height,
                  decoration: BoxDecoration(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              Icons.phone_rounded,
                              size: w * 0.06,
                              color: mode == _AuthMode.phone ? Colors.black : Colors.white,
                            ),
                            SizedBox(width: w * 0.02),
                            Text(
                              'Phone Number',
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              Icons.mail_rounded,
                              size: w * 0.06,
                              color: mode == _AuthMode.email ? Colors.black : Colors.white,
                            ),
                            SizedBox(width: w * 0.02),
                            Text(
                              'Email',
