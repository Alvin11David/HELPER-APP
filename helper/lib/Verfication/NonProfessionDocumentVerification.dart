...
class NonProfessionalDocumentUploadVerificationScreen extends StatefulWidget {
  const NonProfessionalDocumentUploadVerificationScreen({super.key});

  @override
  State<NonProfessionalDocumentUploadVerificationScreen> createState() =>
      _NonProfessionalDocumentUploadVerificationScreenState();
}

class _NonProfessionalDocumentUploadVerificationScreenState
    extends State<NonProfessionalDocumentUploadVerificationScreen> {
  bool _loading = false;
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> onContinue() async {
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => WorkersDashboardScreen()),
      );
    }
