...
import 'package:helper/Verfication/NonProfessionalDocumentVerification.dart';

class NonProfessionalWorkerVerificationScreen extends StatefulWidget {
  const NonProfessionalWorkerVerificationScreen({super.key});

  @override
  State<NonProfessionalWorkerVerificationScreen> createState() =>
      _NonProfessionalWorkerVerificationScreenState();
}

class _NonProfessionalWorkerVerificationScreenState
    extends State<NonProfessionalWorkerVerificationScreen>
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  const NonProfessionalDocumentUploadVerificationScreen(),
                            ),
                          );
                          },
                          child: Row(
