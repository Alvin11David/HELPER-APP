...
import 'package:helper/Verfication/DocumentUploadVerification.dart';

class VerificationInformationVerificationScreen extends StatefulWidget {
  const VerificationInformationVerificationScreen({super.key});

  @override
  State<VerificationInformationVerificationScreen> createState() =>
      _VerificationInformationVerificationScreenState();
}

class _VerificationInformationVerificationScreenState
    extends State<VerificationInformationVerificationScreen>
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) =>
                                    const DocumentUploadVerificationScreen(),
                              ),
                            );
                          },
                          child: Row(
