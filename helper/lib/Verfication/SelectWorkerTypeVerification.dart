...
import 'package:helper/Verfication/NonProfessionWorkerVerification.dart';
import 'package:helper/Verfication/VerificationInformationVerification.dart';

class SelectWorkerTypeVerificationScreen extends StatefulWidget {
  const SelectWorkerTypeVerificationScreen({super.key});

  @override
  State<SelectWorkerTypeVerificationScreen> createState() => _SelectWorkerTypeVerificationScreenState();
}

class _SelectWorkerTypeVerificationScreenState extends State<SelectWorkerTypeVerificationScreen> {
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) =>
                                  const VerificationInformationVerificationScreen(),
                            ),
                          );
                        },
                        child: ClipRRect(
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) =>
                                  const NonProfessionalWorkerVerificationScreen(),
                            ),
                          );
                        },
                        child: ClipRRect(
