                              ...
                              return StreamBuilder<QuerySnapshot>(
                                ...
                                builder: (context, paymentSnapshot) {
                                  ...
                                  if (roleNotifSnapshot.hasData) {
                                    for (var doc
                                        in roleNotifSnapshot.data!.docs) {
                                      final data =
                                          doc.data() as Map<String, dynamic>;
                                      allMessages.add({
                                        'message': data['title'] != null
                                  ...
                                  if (completionSnapshot.hasData) {
                                    for (var doc
                                        in completionSnapshot.data!.docs) {
                                      final data =
                                          doc.data() as Map<String, dynamic>;
                                      final code =
                                          (data['completionCode'] ?? '')
                                  ...
                                  // ...existing code for allMessages...
                                  if (paymentSnapshot.hasData) {
                                    for (var doc
                                        in paymentSnapshot.data!.docs) {
                                      final data =
                                          doc.data() as Map<String, dynamic>;
                                      allMessages.add({
                                        'message':
                                            'Payment successful: ${data['amount'] ?? ''} ${data['currency'] ?? ''}',
                                        'sender': 'system',
                                        'senderId': data['userId'] ?? 'system',
                                        'senderName': 'Payment Notification',
                                        'timestamp':
                                            data['createdAt'] ??
                                            data['timestamp'],
                                        'read': true,
